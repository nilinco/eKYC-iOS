...
SWIFT_CLASS("_TtC4eKYC8BaseView")
...
SWIFT_CLASS("_TtC4eKYC17CardDetectionView")
@interface CardDetectionView : BaseView
- (void)layoutSubviews;
@end


SWIFT_CLASS("_TtC4eKYC17FaceCapturingView")
@interface FaceCapturingView : BaseView
- (void)layoutSubviews;
@end
...
@interface FaceCapturingView (SWIFT_EXTENSION(eKYC)) <AVCaptureFileOutputRecordingDelegate>
...
SWIFT_CLASS("_TtC4eKYC17FaceDetectionView")
@interface FaceDetectionView : BaseView
- (void)layoutSubviews;
@end

@class AVCaptureOutput;

@interface FaceDetectionView (SWIFT_EXTENSION(eKYC)) <AVCaptureVideoDataOutputSampleBufferDelegate>
...
SWIFT_CLASS("_TtC4eKYC12UserSignView")
@interface UserSignView : BaseView
@end
